...
public class File_RW_byByte {public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            in =new FileReader("C:\\java\\1.txt");	// файл для чтения

            out= new FileWriter("C:\\java\\123.txt", true);	// файл для записи разрешено добавление
